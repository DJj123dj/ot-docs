...
<GoodImage src="/img/docs/download.png" size="50%"/>
...
<GoodImage src="/img/docs/app_create.png" size="50%"/>
...
**<InlineLink url="category/config" isdoc="true">everything about config.json</InlineLink>**
:::
...
<GoodImage src="/img/docs/command_help.png" size="50%"/>
