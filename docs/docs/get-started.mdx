...
:::tip
You can find an advanced explanation for all config variables **<InlineLink url="docs/config" isdoc="true">here</InlineLink>**!
:::
...
<LinkBlock mode="emoji" emoji="⚙" isdoc="true" url="docs/config/general" name="How to configure config/general.json?" description="Main Bot Configuration: token, color, permissions, ..."></LinkBlock>
...
You can compare a `question` with a <ColorText color="blue">**modal/form question**</ColorText>.
...
<LinkBlock mode="emoji" emoji="⚙" isdoc="true" url="docs/config/questions" name="How to configure config/questions.json?" description="Question Configuration: the modal questions available in the bot."></LinkBlock>

:::warning frequent mistake
To create multiple questions, you need to copy everything **<ColorText color="yellow">between & together with the `{...}` brackets</ColorText>**!
Then, you need to paste it **<ColorText color="yellow">behind the original one</ColorText>**, but separate it with a comma!
Make sure that they don't have the same ID or the bot will give an error!

<ColorText color="red">**Many people fail to copy-paste it correctly! Make sure to follow the instructions clearly!**</ColorText>
:::
...
You can compare an `option` with a <ColorText color="blue">**button or ticket type**</ColorText>.
...
<LinkBlock mode="emoji" emoji="⚙" isdoc="true" url="docs/config/options" name="How to configure config/options.json?" description="Option Configuration: the ticket types available in the bot."></LinkBlock>

:::warning frequent mistake
To create multiple options, you need to copy everything **<ColorText color="yellow">between & together with the `{...}` brackets</ColorText>**!
Then, you need to paste it **<ColorText color="yellow">behind the original one</ColorText>**, but separate it with a comma!
Make sure that they don't have the same ID or the bot will give an error!
...
You can compare a `panel` with an <ColorText color="blue">**embed or message**</ColorText>.
...
<LinkBlock mode="emoji" emoji="⚙" isdoc="true" url="docs/config/panels" name="How to configure config/panels.json?" description="Panel Configuration: the embeds available in the bot."></LinkBlock>

:::warning frequent mistake
To create multiple panels, you need to copy everything **<ColorText color="yellow">between & together with the `{...}` brackets</ColorText>**!
Then, you need to paste it **<ColorText color="yellow">behind the original one</ColorText>**, but separate it with a comma!
Make sure that they don't have the same ID or the bot will give an error!
...
<InlineLink isdoc="true" url="docs/system/transcripts">Here you can find more info about transcripts!</InlineLink>

<LinkBlock mode="emoji" emoji="⚙" isdoc="true" url="docs/config/transcripts" name="How to configure config/transcripts.json?" description="Transcript Configuration: type, layout, colors, ..."></LinkBlock>
...
<LinkBlock url="docs/config/general" isdoc="true" mode="emoji" emoji="⚙️" name="Config.json In Detail" description="Every variable of config.json explained in the best way possible!"/>
<LinkBlock url="docs/config/general/options" isdoc="true" mode="emoji" emoji="✅" name="Reaction Roles & Websites" description="Discover the other option types!"/>
