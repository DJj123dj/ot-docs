...
<GoodImage src="/img/docs/installation/devportal_permissions.png" size="70%"></GoodImage>

### intents
Every discord bot also needs some **Privileged Gateaway Intents**.
These intents give the bot some extra permissions that may be important for some things.
The `Message Content` intent allows the bot to read text messages in the server.
This is the most important one, because it is needed for some commands to work properly!

<GoodImage src="/img/docs/installation/devportal_intents.png" size="70%"></GoodImage>
