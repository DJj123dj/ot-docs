...
<GoodImage src="/img/docs-v3/installation/devportal_permissions.png" alt="Image of Discord developer portal" size="90%"></GoodImage>
...
<GoodImage src="/img/docs-v3/installation/devportal_intents.png" alt="Image of Discord developer portal" size="90%"></GoodImage>