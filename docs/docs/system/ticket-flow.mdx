...
<GoodImage src="/img/docs/core/firstmsg.png" size="60%"></GoodImage>
...
<GoodImage src="/img/docs/core/firstmsg_claimed.png" size="60%"></GoodImage>
...
<GoodImage src="/img/docs/commands/reopen.png" size="50%"></GoodImage>
