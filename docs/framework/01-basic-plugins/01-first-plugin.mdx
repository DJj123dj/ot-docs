...
:::tip getting started
If you haven't already done so, it's recommended to read the [**🏁 Getting Started**](/docs/framework/getting-started) guide before starting with this article.  
:::
...
- **`"description"`:** <M color="blue">string</M> - A short description of what the plugin does. (Also visible in the logs)
- **`"version"`:** <M color="blue">string</M> - The version of the plugin.
- **`"author"`:** <M color="blue">string</M> - Your Discord/Github username.
...
You've successfully built your first Open Ticket plugin! 🚀  
