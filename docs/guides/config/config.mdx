...
- <C color="blue">`config.json`</C>
- <C color="green">`transcriptconfig.json`</C>
- <C color="red">`core/api/api.json`</C> (⚠️ Developers Only)
...
## config.json
Config.json is **<C color="blue">the most important one</C>** from all of them!
...
<LinkBlock url="docs/config/general" isdoc="true" mode="emoji" emoji="⚙️" name="More info about config.json" description="Click here for more info about config.json!"></LinkBlock>

## transcriptconfig.json
Transcriptconfig.json is **<C color="green">less important</C>** than config.json!
...
## api.json
Api.json is **<C color="red">the least important one</C>** from all of them!
