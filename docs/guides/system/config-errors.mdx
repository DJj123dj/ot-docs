...
Open Ticket has a **config checker system called <C color="blue">ConfigChecker</C>**.
This system is executed before you start the bot & it detects if there is anything wrong with your `config.json` file!

<ScaleImage src="/img/docs-v3/installation/console_checkerjs.png" alt="Image of ConfigChecker in action" size="80%"></ScaleImage>

## Detectable Errors \{#detectable-errors}
**Here are <C color="green">errors that will be detected</C>:**
- missing properties
...
**Here are <C color="red">errors that won't be detected</C>:**
- invalid token
