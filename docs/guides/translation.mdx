...
<LinkBlock mode="emoji" emoji="⚙️" name="Basic Settings" description="Configure the bot language here!" isdoc="true" url="docs/config/general/basic#languagefile"></LinkBlock>
