---
title: ODBlacklist
description: "This is an Open Ticket blacklisted user. This class contains the id of the user this class belongs to & an optional reason for being blacklisted."
...
# ODBlacklist <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/blacklist.ts#L14)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODBlacklist" label="api.ODBlacklist"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`reason`:** <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/>|<ApiUrl url="js:string" label="string"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/blacklist.ts#L18)
