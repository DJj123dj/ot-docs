---
title: ODBuilderManager
description: "This is an Open Ticket builder manager. It contains all Open Ticket builders. You can find messages, embeds, files & dropdowns, buttons & modals all here!"
...
# ODBuilderManager <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L64)
...
## Properties
<Divider></Divider>
#### `buttons` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODButtonManager" label="api.ODButtonManager"/></ApiBlock> \{#prop-buttons}
The manager for all button builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L66)

<Divider></Divider>
#### `dropdowns` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODDropdownManager" label="api.ODDropdownManager"/></ApiBlock> \{#prop-dropdowns}
The manager for all dropdown builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L68)

<Divider></Divider>
#### `embeds` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODEmbedManager" label="api.ODEmbedManager"/></ApiBlock> \{#prop-embeds}
The manager for all embed builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L72)

<Divider></Divider>
#### `files` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODFileManager" label="api.ODFileManager"/></ApiBlock> \{#prop-files}
The manager for all file/attachment builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L70)

<Divider></Divider>
#### `messages` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODMessageManager" label="api.ODMessageManager"/></ApiBlock> \{#prop-messages}
The manager for all message builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L74)

<Divider></Divider>
#### `modals` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODModalManager" label="api.ODModalManager"/></ApiBlock> \{#prop-modals}
The manager for all modal builders

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L76)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODBuilderManager" label="api.ODBuilderManager"/></ApiBlock> \{#method-constructor}
(no description)
