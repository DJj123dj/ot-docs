---
title: ODCheckerArrayStructure
description: "This is an Open Ticket config checker structure. This class will check for an array variable in a config file, customise it in the settings!"
...
# ODCheckerArrayStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L724)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerArrayStructureOptions" label="api.ODCheckerArrayStructureOptions"/></ApiBlock> \{#prop-options}
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerArrayStructure" label="api.ODCheckerArrayStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L727)
