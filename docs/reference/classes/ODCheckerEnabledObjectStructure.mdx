---
title: ODCheckerEnabledObjectStructure
description: "This is an Open Ticket config checker structure. This class will enable an object checker based on a variable match in the object, customise it in the settings!"
...
# ODCheckerEnabledObjectStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L1003)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerEnabledObjectStructureOptions" label="api.ODCheckerEnabledObjectStructureOptions"/></ApiBlock> \{#prop-options}
The options for this checker structure

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L1004)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerEnabledObjectStructure" label="api.ODCheckerEnabledObjectStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`options`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerEnabledObjectStructureOptions" label="api.ODCheckerEnabledObjectStructureOptions"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L1006)
...
- **`value`:** <M color="cyan">object</M> <ApiBlock><ApiUrl url="js:object" label="object"/></ApiBlock> - Parameter Description Lorem Ipsum.
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L1010)
