---
title: ODCheckerFunction
description: "This is an Open Ticket config checker function. It is a global function that will be executed after all config checkers. It can do additional checks for invalid/missing configurations."
...
# ODCheckerFunction <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L227)
...
## Properties
<Divider></Divider>
#### `func` <M color="orange">function</M> <ApiBlock>(manager:<ApiUrl url="class:ODCheckerManager" label="api.ODCheckerManager"/>, functions:<ApiUrl url="class:ODCheckerFunctionManager" label="api.ODCheckerFunctionManager"/>) => <ApiUrl url="interface:ODCheckerResult" label="api.ODCheckerResult"/></ApiBlock> \{#prop-func}
The function itself :)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L229)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerFunction" label="api.ODCheckerFunction"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`func`:** <M color="orange">function</M> <ApiBlock>(manager:<ApiUrl url="class:ODCheckerManager" label="api.ODCheckerManager"/>, functions:<ApiUrl url="class:ODCheckerFunctionManager" label="api.ODCheckerFunctionManager"/>) => <ApiUrl url="interface:ODCheckerResult" label="api.ODCheckerResult"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L231)
