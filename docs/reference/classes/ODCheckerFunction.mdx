...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L232)
...
## Properties
<Divider></Divider>
#### `func` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODCheckerFunctionCallback" label="api.ODCheckerFunctionCallback"/></ApiBlock> \{#prop-func}
The function which will be executed globally after all config checkers.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L234)
...
- **`func`:** <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODCheckerFunctionCallback" label="api.ODCheckerFunctionCallback"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L236)
