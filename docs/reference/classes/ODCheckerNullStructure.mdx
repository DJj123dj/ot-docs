---
title: ODCheckerNullStructure
description: "This is an Open Ticket config checker structure. This class will check for a null variable in a config file, customise it in the settings!"
...
# ODCheckerNullStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L827)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerNullStructureOptions" label="api.ODCheckerNullStructureOptions"/></ApiBlock> \{#prop-options}
The options for this checker structure

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L828)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerNullStructure" label="api.ODCheckerNullStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`options`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerNullStructureOptions" label="api.ODCheckerNullStructureOptions"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L830)
...
- **`value`:** <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/></ApiBlock> - Parameter Description Lorem Ipsum.
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L834)
