---
title: ODCheckerNumberStructure
description: "This is an Open Ticket config checker structure. This class will check for a number variable in a config file, customise it in the settings!"
...
# ODCheckerNumberStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L591)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerNumberStructureOptions" label="api.ODCheckerNumberStructureOptions"/></ApiBlock> \{#prop-options}
The options for this checker structure

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L592)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerNumberStructure" label="api.ODCheckerNumberStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`options`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerNumberStructureOptions" label="api.ODCheckerNumberStructureOptions"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L594)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L598)
