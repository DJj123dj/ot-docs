...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L506)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L509)
