---
title: ODCheckerStringStructure
description: "This is an Open Ticket config checker structure. This class will check for a string variable in a config file, customise it in the settings!"
...
# ODCheckerStringStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L511)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerStringStructureOptions" label="api.ODCheckerStringStructureOptions"/></ApiBlock> \{#prop-options}
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerStringStructure" label="api.ODCheckerStringStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L514)
