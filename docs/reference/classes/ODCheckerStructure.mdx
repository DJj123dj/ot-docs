---
title: ODCheckerStructure
description: "This is an Open Ticket config checker structure. This class will check for a single variable in a config file, customise it in the settings!"
...
# ODCheckerStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L400)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerStructureOptions" label="api.ODCheckerStructureOptions"/></ApiBlock> \{#prop-options}
The options for this checker structure

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L404)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerStructure" label="api.ODCheckerStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`options`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerStructureOptions" label="api.ODCheckerStructureOptions"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L406)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L412)
