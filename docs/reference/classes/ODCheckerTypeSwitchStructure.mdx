---
title: ODCheckerTypeSwitchStructure
description: "This is an Open Ticket config checker structure. This class will switch checkers based on the type of the variable in a config file, customise it in the settings!"
...
# ODCheckerTypeSwitchStructure <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L877)
...
<Divider></Divider>
#### `options` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerTypeSwitchStructureOptions" label="api.ODCheckerTypeSwitchStructureOptions"/></ApiBlock> \{#prop-options}
The options for this checker structure

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L878)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCheckerTypeSwitchStructure" label="api.ODCheckerTypeSwitchStructure"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`options`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODCheckerTypeSwitchStructureOptions" label="api.ODCheckerTypeSwitchStructureOptions"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L880)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/checker.ts#L884)
