---
title: ODConfig
description: "This is an Open Ticket config helper. This class doesn't do anything at all, it just gives a template & basic methods for a config. Use `ODJsonConfig` instead!"
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/config.ts#L38)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODConfig" label="api.ODConfig"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/config.ts#L46)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/config.ts#L52)
