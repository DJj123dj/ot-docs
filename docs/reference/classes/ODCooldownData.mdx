---
title: ODCooldownData
description: "This is Open Ticket cooldown data. It contains the instance of an active cooldown (e.g. for a user). It is handled by the cooldown itself."
...
# ODCooldownData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/cooldown.ts#L31)

<FlexHorizontal>
<div style={{width:"30%"}}>
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`active`](#prop-active)**</li>
...
## Properties
<Divider></Divider>
#### `active` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-active}
Is this cooldown active?

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/cooldown.ts#L33)

<Divider></Divider>
#### `data` <M color="brown">type</M> <ApiBlock>Data</ApiBlock> \{#prop-data}
Additional data of this cooldown instance. (different for each cooldown type)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/cooldown.ts#L35)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODCooldownData" label="api.ODCooldownData"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`active`:** <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> - Parameter Description Lorem Ipsum.
- **`data`:** <M color="brown">type</M> <ApiBlock>Data</ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/cooldown.ts#L37)
