---
title: ODDebugger
description: "This is the Open Ticket debugger. It is a simple wrapper around the `ODConsoleManager` to handle debugging (primarily for `ODManagers`)."
...
# ODDebugger <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L410)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L412)

<Divider></Divider>
#### `visible` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-visible}
When enabled, debug logs are also shown in the console.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L414)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODDebugger" label="api.ODDebugger"/></ApiBlock> \{#method-constructor}
(no description)

<details>
<summary>**View Parameters (1)**</summary>
- **`console`:** <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODConsoleManager" label="api.ODConsoleManager"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L416)

<Divider></Divider>
#### `debug()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#method-debug}
...
- **`params`:** <M color="pink">array</M> <ApiBlock>\{key:<ApiUrl url="js:string" label="string"/>, value:<ApiUrl url="js:string" label="string"/>\}[]</ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L421)
