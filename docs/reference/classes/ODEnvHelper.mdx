...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L657)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L659)

<Divider></Divider>
#### `env` <M color="cyan">object</M> <ApiBlock><ApiUrl url="js:object" label="object"/></ApiBlock> \{#prop-env}
All variables found in `process.env`

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L661)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L663)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L672)
