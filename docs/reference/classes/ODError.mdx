---
title: ODError
description: "This is an Open Ticket error. It is used to render and log Node.js errors & crashes in a styled way to the console & `otdebug.txt` file!"
...
# ODError <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L190)

<FlexHorizontal>
<div style={{width:"30%"}} className="otdocs-flex-mobile-width">
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`error`](#prop-error)**</li>
        <li>**[`origin`](#prop-origin)**</li>
    </ul>
</div>
<div style={{width:"30%"}} className="otdocs-flex-mobile-width">
...
## Properties
<Divider></Divider>
#### `error` <M color="brown">type</M> <ApiBlock>Error|<ApiUrl url="class:ODSystemError" label="api.ODSystemError"/>|<ApiUrl url="class:ODPluginError" label="api.ODPluginError"/></ApiBlock> \{#prop-error}
The original error that this class wraps around

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L192)

<Divider></Divider>
#### `origin` <M color="brown">type</M> <ApiBlock>@types/node.UncaughtExceptionOrigin</ApiBlock> \{#prop-origin}
The origin of the original error

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L194)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODError" label="api.ODError"/></ApiBlock> \{#method-constructor}
(no description)

<details>
<summary>**View Parameters (2)**</summary>
- **`error`:** <M color="brown">type</M> <ApiBlock>Error|<ApiUrl url="class:ODSystemError" label="api.ODSystemError"/>|<ApiUrl url="class:ODPluginError" label="api.ODPluginError"/></ApiBlock> - Parameter Description Lorem Ipsum.
- **`origin`:** <M color="brown">type</M> <ApiBlock>@types/node.UncaughtExceptionOrigin</ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L196)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L202)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L219)
