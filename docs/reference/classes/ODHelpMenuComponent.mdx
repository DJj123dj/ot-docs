---
title: ODHelpMenuComponent
description: "This is an Open Ticket help menu component. It can render something on the Open Ticket help menu."
...
# ODHelpMenuComponent <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L17)
...
<Divider></Divider>
#### `render` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODHelpMenuComponentRenderer" label="api.ODHelpMenuComponentRenderer"/></ApiBlock> \{#prop-render}
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODHelpMenuComponent" label="api.ODHelpMenuComponent"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`render`:** <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODHelpMenuComponentRenderer" label="api.ODHelpMenuComponentRenderer"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L23)
