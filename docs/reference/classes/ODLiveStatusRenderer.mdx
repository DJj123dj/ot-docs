---
title: ODLiveStatusRenderer
description: "This is the Open Ticket livestatus renderer. It's responsible for rendering all LiveStatus messages to the console."
...
# ODLiveStatusRenderer <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L618)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODLiveStatusRenderer" label="api.ODLiveStatusRenderer"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L622)
...
<details>
<summary>**View Parameters (1)**</summary>
- **`messages`:** <M color="pink">array</M> <ApiBlock><ApiUrl url="interface:ODLiveStatusSourceData" label="api.ODLiveStatusSourceData"/>[]</ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L627)
