---
title: ODLiveStatusSource
description: "This is the Open Ticket livestatus source. It is an empty template for a livestatus source."
...
# ODLiveStatusSource <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L486)
...
## Properties
<Divider></Divider>
#### `data` <M color="pink">array</M> <ApiBlock><ApiUrl url="interface:ODLiveStatusSourceData" label="api.ODLiveStatusSourceData"/>[]</ApiBlock> \{#prop-data}
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODLiveStatusSource" label="api.ODLiveStatusSource"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L490)
...
<Divider></Divider>
#### `setData()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:void" label="void"/></ApiBlock> \{#method-setData}
