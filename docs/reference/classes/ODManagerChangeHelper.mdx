---
title: ODManagerChangeHelper
description: "This is an Open Ticket manager change helper. It is used to let the \"onChange\" event in the `ODManager` class work."
...
# ODManagerChangeHelper <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L104)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODManagerChangeHelper" label="api.ODManagerChangeHelper"/></ApiBlock> \{#method-constructor}
(no description)
...
<Divider></Divider>
#### <C color="orange">protected</C> `_change()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:void" label="void"/></ApiBlock> \{#method-_change}
...
<Divider></Divider>
#### `changed()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:void" label="void"/></ApiBlock> \{#method-changed}
