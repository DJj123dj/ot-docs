---
title: ODManagerData
description: "This is Open Ticket manager data. It provides a template for all classes that are used in the `ODManager`."
...
# ODManagerData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L170)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODManagerData" label="api.ODManagerData"/></ApiBlock> \{#method-constructor}
(no description)
