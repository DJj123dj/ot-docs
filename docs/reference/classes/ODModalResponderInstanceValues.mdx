---
title: ODModalResponderInstanceValues
description: "This is an Open Ticket modal responder instance values manager. This class will manage all fields from the modals."
...
# ODModalResponderInstanceValues <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/responder.ts#L990)
...
<div style={{width:"30%"}}>
    ...
    <ul>
        ...
        <li>**[`getTextField`](#method-getTextField)**</li>
    </ul>
</div>
<div style={{width:"30%"}}>
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODModalResponderInstanceValues" label="api.ODModalResponderInstanceValues"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/responder.ts#L994)

<Divider></Divider>
#### `getTextField()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#method-getTextField}
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/responder.ts#L999)
