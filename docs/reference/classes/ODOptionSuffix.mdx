---
title: ODOptionSuffix
description: "This is an Open Ticket option suffix. This class can generate a suffix for a discord channel name from a specific option."
...
# ODOptionSuffix <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/option.ts#L367)
...
<Divider></Divider>
#### `option` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODTicketOption" label="api.ODTicketOption"/></ApiBlock> \{#prop-option}
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODOptionSuffix" label="api.ODOptionSuffix"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/option.ts#L377)
