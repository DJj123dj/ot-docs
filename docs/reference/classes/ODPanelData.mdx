---
title: ODPanelData
description: "This is Open Ticket panel data. This class contains a single property for a panel. (string, number, boolean, object, array, null)"
...
# ODPanelData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L143)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODPanelData" label="api.ODPanelData"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L147)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L161)
