---
title: ODQuestionData
description: "This is Open Ticket question data. This class contains a single property for a question. (string, number, boolean, object, array, null)"
...
# ODQuestionData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L105)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODQuestionData" label="api.ODQuestionData"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L109)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L123)
