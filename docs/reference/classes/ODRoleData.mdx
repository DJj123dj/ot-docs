---
title: ODRoleData
description: "This is Open Ticket role data. This class contains a single property for a role. (string, number, boolean, object, array, null)"
...
# ODRoleData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L132)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODRoleData" label="api.ODRoleData"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L136)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L150)
