---
title: ODTextCommand
description: "This is an Open Ticket text command. When registered, you can listen for this command using the `ODCommandResponder`. The advantages of using this class for creating a text command are:"
...
# ODTextCommand <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1119)
...
## Properties
<Divider></Divider>
#### `builder` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODTextCommandBuilder" label="api.ODTextCommandBuilder"/></ApiBlock> \{#prop-builder}
The builder for this slash command.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1121)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1123)

<Divider></Divider>

## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODTextCommand" label="api.ODTextCommand"/></ApiBlock> \{#method-constructor}
(no description)
...
- **`builder`:** <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODTextCommandBuilder" label="api.ODTextCommandBuilder"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1125)
