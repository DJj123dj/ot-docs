---
title: ODTicketData
description: "This is Open Ticket ticket data. This class contains a single property for a ticket. (string, number, boolean, object, array, null)"
...
# ODTicketData <M color="purple">class</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/ticket.ts#L270)
...
## Methods
<Divider></Divider>
#### `constructor()` <M color="orange">function</M> <ApiBlock><ApiUrl url="class:ODTicketData" label="api.ODTicketData"/></ApiBlock> \{#method-constructor}
(no description)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/ticket.ts#L274)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/ticket.ts#L288)
