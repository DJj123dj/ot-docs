...
<div style={{width:"30%"}} className="otdocs-flex-mobile-width">
    ...
    <ul>
        ...
        <li>**[`migrateAfterInit`](#method-migrateAfterInit)**</li>
    </ul>
</div>
<div style={{width:"30%"}} className="otdocs-flex-mobile-width">
...
- **`afterInitFunc`:** <M color="orange">function</M> <ApiBlock>() => <ApiUrl url="js:void" label="void"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> - Parameter Description Lorem Ipsum.
</details>

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/startup/init.ts#L131)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/startup/init.ts#L137)

<Divider></Divider>
#### `migrateAfterInit()` <M color="orange">function</M> <ApiBlock><ApiUrl url="js:promise" label="Promise"/></ApiBlock> \{#method-migrateAfterInit}
Run this version migration as a plugin (after other plugins have loaded). Returns `false` when something goes wrong.



> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/startup/init.ts#L146)
