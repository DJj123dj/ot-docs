...
If you're **unable to configure the options correctly**, feel free to join our discord server!
...
<ScaleImage src="/img/docs-v4/panel-buttons.png" size="40%"></ScaleImage>
...
<ScaleImage src="/img/docs-v4/dm-message.png" size="50%"></ScaleImage>
...
<ScaleImage src="/img/docs-v4/ticket-message.png" size="50%"></ScaleImage>
...
<ScaleImage src="/img/docs-v4/cooldown.png" size="50%"></ScaleImage>
