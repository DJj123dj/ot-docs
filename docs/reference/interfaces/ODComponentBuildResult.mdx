---
title: ODComponentBuildResult
description: "This interface contains the result from a built component (button/dropdown). This can be used in the `ODMessage` builder!"
...
# ODComponentBuildResult <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L91)

<FlexHorizontal>
<div style={{width:"50%"}}>
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`component`](#prop-component)**</li>
        <li>**[`id`](#prop-id)**</li>
    </ul>
</div>
<div style={{width:"50%"}}>
...
## Properties
<Divider></Divider>
#### `component` <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/>|"\n"|<ApiUrl url="https://discord.js.org/docs/packages/builders/main/MessageActionRowComponentBuilder:TypeAlias" label="discord.MessageActionRowComponentBuilder"/></ApiBlock> \{#prop-component}
The discord component or `\n` when it is a spacer between action rows

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L95)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L93)
