---
title: ODConsoleMessageParam
description: "This interface contains all data required for a console log parameter within Open Ticket."
...
# ODConsoleMessageParam <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L18)

<FlexHorizontal>
<div style={{width:"50%"}}>
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`hidden`](#prop-hidden)**</li>
        <li>**[`key`](#prop-key)**</li>
...
## Properties
<Divider></Divider>
#### <C color="red">optional</C> `hidden` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-hidden}
When enabled, this parameter will only be shown in the debug file.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L24)

<Divider></Divider>
#### `key` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-key}
The key of this parameter.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L20)

<Divider></Divider>
#### `value` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-value}
The value of this parameter.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L22)
