...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L757)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L758)

<Divider></Divider>
#### `translators` <M color="pink">array</M> <ApiBlock><ApiUrl url="js:string" label="string"/>[]</ApiBlock> \{#prop-translators}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L759)
