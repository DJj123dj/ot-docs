---
title: ODEmbedBuildResult
description: "This interface contains the result from a built embed. This can be used in the `ODMessage` builder!"
...
# ODEmbedBuildResult <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L681)
...
## Properties
<Divider></Divider>
#### `embed` <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/>|<ApiUrl url="https://discord.js.org/docs/packages/discord.js/main/EmbedBuilder:Class" label="discord.EmbedBuilder"/></ApiBlock> \{#prop-embed}
The discord embed

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L685)

<Divider></Divider>
#### `id` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODId" label="api.ODId"/></ApiBlock> \{#prop-id}
The id of this embed

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/builder.ts#L683)
