---
title: ODFormattedJsonDatabaseIds_DefaultOptions
...
# ODFormattedJsonDatabaseIds_DefaultOptions <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/database.ts#L211)

<FlexHorizontal>
<div style={{width:"50%"}}>
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`opendiscord:used-option`](#prop-opendiscord-used-option)**</li>
    </ul>
</div>
<div style={{width:"50%"}}>
...
## Properties
<Divider></Divider>
#### `opendiscord:used-option` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODOptionJson" label="api.ODOptionJson"/></ApiBlock> \{#prop-opendiscord-used-option}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/database.ts#L212)
