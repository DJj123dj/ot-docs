---
title: ODFormattedJsonDatabaseIds_DefaultUsers
...
# ODFormattedJsonDatabaseIds_DefaultUsers <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/database.ts#L159)
...
## Properties
<Divider></Divider>
#### `opendiscord:blacklist` <M color="gray">interface</M> <ApiBlock><ApiUrl url="interface:ODTicketJson" label="api.ODTicketJson"/></ApiBlock> \{#prop-opendiscord-blacklist}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/database.ts#L160)
