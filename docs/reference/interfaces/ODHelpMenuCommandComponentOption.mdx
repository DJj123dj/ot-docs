---
title: ODHelpMenuCommandComponentOption
description: "This interface contains a command option for the `ODHelpMenuCommandComponent`."
...
# ODHelpMenuCommandComponentOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L46)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L48)

<Divider></Divider>
#### `optional` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-optional}
Is this option optional?

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L50)
