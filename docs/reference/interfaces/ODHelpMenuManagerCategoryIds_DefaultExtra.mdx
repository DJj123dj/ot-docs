---
title: ODHelpMenuManagerCategoryIds_DefaultExtra
description: "This interface is a list of ids available in the `ODHelpMenuCategory_DefaultExtra` class. It's used to generate typescript declarations for this class."
...
# ODHelpMenuManagerCategoryIds_DefaultExtra <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/helpmenu.ts#L294)
