---
title: ODJsonConfig_DefaultInfo
description: "This object contains a few URLs and metadata for the config."
...
# ODJsonConfig_DefaultInfo <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L83)

<FlexHorizontal>
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`discord`](#prop-discord)**</li>
        <li>**[`support`](#prop-support)**</li>
...
## Properties
<Divider></Divider>
#### `discord` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-discord}
...
<Divider></Divider>
#### `support` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-support}
A link to the Open Ticket documentation.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L85)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L89)
