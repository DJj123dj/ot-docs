---
title: ODJsonConfig_DefaultMessageSettingsType
description: "This interface is an object which has all properties for the \"system\".\"messages\".... object in the `general.json` config!"
...
# ODJsonConfig_DefaultMessageSettingsType <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L68)
...
## Properties
<Divider></Divider>
#### `dm` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-dm}
Enable sending DM logs to the ticket creator for this action.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L70)

<Divider></Divider>
#### `logs` <M color="red">boolean</M> <ApiBlock><ApiUrl url="js:boolean" label="boolean"/></ApiBlock> \{#prop-logs}
Enable sending logsto the log channel for this action.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L72)
