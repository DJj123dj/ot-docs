---
title: ODJsonConfig_DefaultSystemLimits
description: "All settings related to global ticket limits."
...
# ODJsonConfig_DefaultSystemLimits <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L105)
...
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
    ...
    <ul>
        ...
        <li>**[`globalMaximum`](#prop-globalMaximum)**</li>
        <li>**[`userMaximum`](#prop-userMaximum)**</li>
    </ul>
</div>
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L107)

<Divider></Divider>
#### `globalMaximum` <M color="green">number</M> <ApiBlock><ApiUrl url="js:number" label="number"/></ApiBlock> \{#prop-globalMaximum}
The maximum amount of tickets that are allowed in the server at the same time.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L109)

<Divider></Divider>
#### `userMaximum` <M color="green">number</M> <ApiBlock><ApiUrl url="js:number" label="number"/></ApiBlock> \{#prop-userMaximum}
The maximum amount of tickets that a user is allowed to create at the same time.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L111)
