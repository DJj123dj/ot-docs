---
title: ODJsonConfig_DefaultSystemLogs
description: "All settings related to the log channel."
...
# ODJsonConfig_DefaultSystemLogs <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L95)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L99)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L97)
