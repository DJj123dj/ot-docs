---
title: ODLiveStatusManagerIds_Default
description: "This interface is a list of ids available in the `ODLiveStatusManager_Default` class. It's used to generate typescript declarations for this class."
...
# ODLiveStatusManagerIds_Default <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/console.ts#L11)

<FlexHorizontal>
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`opendiscord:default-djdj-dev`](#prop-opendiscord-default-djdj-dev)**</li>
    </ul>
</div>
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
...
## Properties
<Divider></Divider>
#### `opendiscord:default-djdj-dev` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODLiveStatusUrlSource" label="api.ODLiveStatusUrlSource"/></ApiBlock> \{#prop-opendiscord-default-djdj-dev}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/console.ts#L12)
