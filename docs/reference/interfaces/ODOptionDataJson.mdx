---
title: ODOptionDataJson
description: "The JSON representatation from a single option property."
...
# ODOptionDataJson <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/option.ts#L40)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/option.ts#L42)

<Divider></Divider>
#### `value` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODValidJsonType" label="api.ODValidJsonType"/></ApiBlock> \{#prop-value}
The value of this property.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/option.ts#L44)
