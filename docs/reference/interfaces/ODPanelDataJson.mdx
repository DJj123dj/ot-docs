---
title: ODPanelDataJson
description: "The JSON representatation from a single panel property."
...
# ODPanelDataJson <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L33)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L35)

<Divider></Divider>
#### `value` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODValidJsonType" label="api.ODValidJsonType"/></ApiBlock> \{#prop-value}
The value of this property.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L37)
