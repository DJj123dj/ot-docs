---
title: ODPanelJson
description: "The JSON representatation from a single panel."
...
# ODPanelJson <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L43)
...
## Properties
<Divider></Divider>
#### `data` <M color="pink">array</M> <ApiBlock><ApiUrl url="interface:ODPanelDataJson" label="api.ODPanelDataJson"/>[]</ApiBlock> \{#prop-data}
The full list of properties/variables related to this panel.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L49)

<Divider></Divider>
#### `id` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-id}
The id of this panel.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L45)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/panel.ts#L47)
