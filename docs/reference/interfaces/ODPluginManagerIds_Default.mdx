---
title: ODPluginManagerIds_Default
description: "This interface is a list of ids available in the `ODPluginManager_Default` class. It's used to generate typescript declarations for this class."
...
# ODPluginManagerIds_Default <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/plugin.ts#L11)
