---
title: ODPostManagerIds_Default
description: "This interface is a list of ids available in the `ODPostManager_Default` class. It's used to generate typescript declarations for this class."
...
# ODPostManagerIds_Default <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/post.ts#L12)
...
## Properties
<Divider></Divider>
#### `opendiscord:logs` <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/>|<ApiUrl url="class:ODPost" label="api.ODPost"/></ApiBlock> \{#prop-opendiscord-logs}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/post.ts#L13)

<Divider></Divider>
#### `opendiscord:transcripts` <M color="brown">type</M> <ApiBlock><ApiUrl url="js:null" label="null"/>|<ApiUrl url="class:ODPost" label="api.ODPost"/></ApiBlock> \{#prop-opendiscord-transcripts}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/post.ts#L14)
