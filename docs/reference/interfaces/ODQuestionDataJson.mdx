---
title: ODQuestionDataJson
description: "The JSON representatation from a single question property."
...
# ODQuestionDataJson <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L32)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L34)

<Divider></Divider>
#### `value` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODValidJsonType" label="api.ODValidJsonType"/></ApiBlock> \{#prop-value}
The value of this property.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/question.ts#L36)
