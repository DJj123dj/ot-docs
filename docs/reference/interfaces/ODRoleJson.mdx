---
title: ODRoleJson
description: "The JSON representatation from a single role."
...
# ODRoleJson <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L43)
...
## Properties
<Divider></Divider>
#### `data` <M color="pink">array</M> <ApiBlock><ApiUrl url="interface:ODRoleDataJson" label="api.ODRoleDataJson"/>[]</ApiBlock> \{#prop-data}
The full list of properties/variables related to this role.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L49)

<Divider></Divider>
#### `id` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-id}
The id of this role.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L45)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L47)
