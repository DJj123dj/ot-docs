---
title: ODStatGlobalScopeIds_DefaultSystem
description: "This interface is a list of ids available in the `ODStatScope_DefaultSystem` class. It's used to generate typescript declarations for this class."
...
# ODStatGlobalScopeIds_DefaultSystem <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/stat.ts#L121)

<FlexHorizontal>
<div style={{width:"50%"}}>
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`opendiscord:startup-date`](#prop-opendiscord-startup-date)**</li>
...
## Properties
<Divider></Divider>
#### `opendiscord:startup-date` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODDynamicStat" label="api.ODDynamicStat"/></ApiBlock> \{#prop-opendiscord-startup-date}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/stat.ts#L122)

<Divider></Divider>
#### `opendiscord:version` <M color="purple">class</M> <ApiBlock><ApiUrl url="class:ODDynamicStat" label="api.ODDynamicStat"/></ApiBlock> \{#prop-opendiscord-version}
(no description)

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/stat.ts#L123)
