---
title: ODTextCommandBuilderBaseOption
description: "The default option builder for text commands."
...
# ODTextCommandBuilderBaseOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L981)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock><ApiUrl url="type:ODTextCommandBuilderBaseOptionType" label="api.ODTextCommandBuilderBaseOptionType"/></ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L985)
