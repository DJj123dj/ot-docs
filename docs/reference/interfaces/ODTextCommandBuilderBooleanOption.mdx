---
title: ODTextCommandBuilderBooleanOption
description: "The boolean option builder for text commands."
...
# ODTextCommandBuilderBooleanOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1029)

<FlexHorizontal>
<div style={{width:"50%"}} className="otdocs-flex-mobile-width">
    #### Properties \{#overview-properties}
    <ul>
        <li>**[`falseValue`](#prop-falseValue)**</li>
        <li>**[`name`](#prop-name)**</li>
        <li>**[`required`](#prop-required)**</li>
        <li>**[`trueValue`](#prop-trueValue)**</li>
...
## Properties
<Divider></Divider>
#### <C color="blue">optional</C> `falseValue` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-falseValue}
The value when `false`

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1034)
...
<Divider></Divider>
#### <C color="blue">optional</C> `trueValue` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-trueValue}
The value when `true`

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1032)

<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"boolean"</ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1030)
