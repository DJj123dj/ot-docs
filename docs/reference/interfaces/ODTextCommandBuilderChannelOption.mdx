---
title: ODTextCommandBuilderChannelOption
description: "The channel option builder for text commands."
...
# ODTextCommandBuilderChannelOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1040)
...
## Properties
<Divider></Divider>
#### <C color="pink">optional</C> `channelTypes` <M color="pink">array</M> <ApiBlock>discord-api-types.GuildChannelType[]</ApiBlock> \{#prop-channelTypes}
When specified, only allow the following channel types

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1043)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"channel"</ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1041)
