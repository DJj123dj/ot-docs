---
title: ODTextCommandBuilderGuildMemberOption
description: "The guild member option builder for text commands."
...
# ODTextCommandBuilderGuildMemberOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1063)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"guildmember"</ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1064)
