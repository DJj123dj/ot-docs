---
title: ODTextCommandBuilderMentionableOption
description: "The mentionable option builder for text commands."
...
# ODTextCommandBuilderMentionableOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1070)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"mentionable"</ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1071)
