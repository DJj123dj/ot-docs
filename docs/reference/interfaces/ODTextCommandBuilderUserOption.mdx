---
title: ODTextCommandBuilderUserOption
description: "The user option builder for text commands."
...
# ODTextCommandBuilderUserOption <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1056)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"user"</ApiBlock> \{#prop-type}
The type of this option

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1057)
