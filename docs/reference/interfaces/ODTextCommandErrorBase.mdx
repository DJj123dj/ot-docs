---
title: ODTextCommandErrorBase
description: "The object returned from a text command error callback."
...
# ODTextCommandErrorBase <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1166)
...
## Properties
<Divider></Divider>
#### `msg` <M color="brown">type</M> <ApiBlock><ApiUrl url="https://discord.js.org/docs/packages/discord.js/main/Message:Class" label="discord.Message"/></ApiBlock> \{#prop-msg}
The message this error originates from

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1170)

<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"unknown_prefix"|"unknown_command"|"invalid_option"|"missing_option"</ApiBlock> \{#prop-type}
The type of text command error

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1168)
