---
title: ODTextCommandErrorUnknownPrefix
description: "The object returned from a text command unknown prefix error callback."
...
# ODTextCommandErrorUnknownPrefix <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1176)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"unknown_prefix"</ApiBlock> \{#prop-type}
The type of text command error

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1177)
