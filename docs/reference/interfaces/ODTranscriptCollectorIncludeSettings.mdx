...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L441)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L445)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L447)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L443)
