---
title: ODTranscriptComponentData
description: "A universal representatation of a discord message action row component for transcripts."
...
# ODTranscriptComponentData <M color="gray">interface</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L576)
...
<Divider></Divider>
#### `type` <M color="brown">type</M> <ApiBlock>"button"|"dropdown"</ApiBlock> \{#prop-type}
The type of this component.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L582)
