...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L536)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L542)

<Divider></Divider>
#### `name` <M color="blue">string</M> <ApiBlock><ApiUrl url="js:string" label="string"/></ApiBlock> \{#prop-name}
The name of this embed field.

> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L538)
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L540)
