---
title: ODClientActivityStatus
description: "Possible activity statuses for the bot."
...
# ODClientActivityStatus <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L332)
...
## Definition
#### <ApiBlock>"online"|"invisible"|"idle"|"dnd"</ApiBlock> {#definition-code}
