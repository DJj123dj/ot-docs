---
title: ODClientActivityType
description: "Possible activity types for the bot."
...
# ODClientActivityType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L328)
...
## Definition
#### <ApiBlock>"playing"|"listening"|"watching"|"custom"|false</ApiBlock> {#definition-code}
