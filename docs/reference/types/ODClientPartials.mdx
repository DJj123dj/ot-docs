---
title: ODClientPartials
description: "A list of partials required for the bot to work. (`Message` & `Channel` are for receiving DM messages from uncached channels)"
...
# ODClientPartials <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L22)
...
## Definition
#### <ApiBlock>"User"|"Channel"|"GuildMember"|"Message"|"Reaction"|"GuildScheduledEvent"|"ThreadMember"</ApiBlock> {#definition-code}
