---
title: ODClientPriviligedIntents
description: "A list of priviliged intents required to be enabled in the developer portal."
...
# ODClientPriviligedIntents <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L18)
...
## Definition
#### <ApiBlock>"GuildMembers"|"MessageContent"|"Presence"</ApiBlock> {#definition-code}
