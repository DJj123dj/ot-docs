---
title: ODConsoleMessageTypes
description: "This is a collection of all the default console message types within Open Ticket."
...
# ODConsoleMessageTypes <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L227)
...
## Definition
#### <ApiBlock>"info"|"system"|"plugin"|"debug"|"warning"|"error"</ApiBlock> {#definition-code}
