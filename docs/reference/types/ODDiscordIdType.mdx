---
title: ODDiscordIdType
description: "A list of all available discord ID types. Used in the config checker."
...
# ODDiscordIdType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L46)
...
## Definition
#### <ApiBlock>"role"|"server"|"channel"|"category"|"user"|"member"|"interaction"|"message"</ApiBlock> {#definition-code}
