---
title: ODDynamicStatRenderer
description: "This callback will render a single dynamic statistic for a discord embed/message."
...
# ODDynamicStatRenderer <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/stat.ts#L277)
...
## Definition
#### <ApiBlock>(scopeId:<ApiUrl url="js:string" label="string"/>, guild:discord.discord.Guild, channel:discord.discord.TextBasedChannel, user:discord.discord.User) => <ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
