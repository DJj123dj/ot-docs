---
title: ODHelpMenuComponentRenderer
description: "This is the callback of the help menu component renderer. It also contains information about how & where it is rendered."
...
# ODHelpMenuComponentRenderer <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L10)
...
## Definition
#### <ApiBlock>(page:<ApiUrl url="js:number" label="number"/>, category:<ApiUrl url="js:number" label="number"/>, location:<ApiUrl url="js:number" label="number"/>, mode:"slash"|"text") => <ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
