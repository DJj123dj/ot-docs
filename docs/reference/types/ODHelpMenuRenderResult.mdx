---
title: ODHelpMenuRenderResult
description: "This is the array returned when the help menu has been rendered successfully. It contains a list of pages, which contain categories by name & value (content)."
...
# ODHelpMenuRenderResult <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/helpmenu.ts#L148)
...
## Definition
#### <ApiBlock>(\{name:<ApiUrl url="js:string" label="string"/>, value:<ApiUrl url="js:string" label="string"/>\}[])[]</ApiBlock> {#definition-code}
