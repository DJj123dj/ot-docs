---
title: ODInterfaceWithPartialProperty
description: "This is a utility type to create an interface where some properties are optional!"
...
# ODInterfaceWithPartialProperty <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L41)
...
## Definition
#### <ApiBlock>Omit&Partial</ApiBlock> {#definition-code}
