---
title: ODJsonConfig_DefaultCmdPermissionSettingsType
description: "This type is a collection of command permission settings for the \"system\".\"permissions\".... object in the `general.json` config!"
...
# ODJsonConfig_DefaultCmdPermissionSettingsType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/config.ts#L78)
...
## Definition
#### <ApiBlock>"admin"|"everyone"|"none"|<ApiUrl url="js:string" label="string"/></ApiBlock> {#definition-code}
