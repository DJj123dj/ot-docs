---
title: ODJsonDatabaseStructure
description: "This is the structure of how a JSON database file!"
...
# ODJsonDatabaseStructure <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/database.ts#L103)
...
## Definition
#### <ApiBlock>\{category:<ApiUrl url="js:string" label="string"/>, key:<ApiUrl url="js:string" label="string"/>, value:<ApiUrl url="type:ODValidJsonType" label="api.ODValidJsonType"/>\}[]</ApiBlock> {#definition-code}
