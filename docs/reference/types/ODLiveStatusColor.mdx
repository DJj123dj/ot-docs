---
title: ODLiveStatusColor
description: "This is a collection of all the colors available within the LiveStatus system."
...
# ODLiveStatusColor <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L435)
...
## Definition
#### <ApiBlock>"normal"|"red"|"green"|"blue"|"yellow"|"white"|"gray"|"magenta"|"cyan"</ApiBlock> {#definition-code}
