---
title: ODManagerAddCallback
description: "This is a callback for the `onAdd` event in the `ODManager`"
...
# ODManagerAddCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L188)
...
## Definition
#### <ApiBlock>(data:DataType, overwritten:<ApiUrl url="js:boolean" label="boolean"/>) => <ApiUrl url="js:void" label="void"/></ApiBlock> {#definition-code}
