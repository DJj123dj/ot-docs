---
title: ODManagerCallback
description: "This is a callback for the `onChange` and `onRemove` events in the `ODManager`"
...
# ODManagerCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L184)
...
## Definition
#### <ApiBlock>(data:DataType) => <ApiUrl url="js:void" label="void"/></ApiBlock> {#definition-code}
