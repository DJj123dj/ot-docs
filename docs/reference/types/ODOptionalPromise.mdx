---
title: ODOptionalPromise
description: "This is a simple type to represent a type as normal value or a promise value."
...
# ODOptionalPromise <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L15)
...
## Definition
#### <ApiBlock>T|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
