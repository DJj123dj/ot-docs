---
title: ODPermissionEmbedType
description: "This type contains all types available in the `opendiscord:no-permissions` embed."
...
# ODPermissionEmbedType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/permission.ts#L22)
...
## Definition
#### <ApiBlock>"developer"|"owner"|"admin"|"moderator"|"support"|"member"|"discord-administrator"</ApiBlock> {#definition-code}
