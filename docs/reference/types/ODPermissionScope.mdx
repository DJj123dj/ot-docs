---
title: ODPermissionScope
description: "The scope in which a certain permission is active."
...
# ODPermissionScope <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/permission.ts#L16)
...
## Definition
#### <ApiBlock>"global-user"|"channel-user"|"global-role"|"channel-role"</ApiBlock> {#definition-code}
