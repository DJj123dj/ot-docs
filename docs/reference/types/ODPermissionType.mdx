---
title: ODPermissionType
description: "All available permission types/levels. Can be used in the `ODPermission` class."
...
# ODPermissionType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/permission.ts#L11)
...
## Definition
#### <ApiBlock>"member"|"support"|"moderator"|"admin"|"owner"|"developer"</ApiBlock> {#definition-code}
