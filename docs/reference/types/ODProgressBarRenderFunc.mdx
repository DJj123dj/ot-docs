---
title: ODProgressBarRenderFunc
description: "This is the render function for an Open Ticket console progress bar."
...
# ODProgressBarRenderFunc <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/progressbar.ts#L40)
...
## Definition
#### <ApiBlock>(settings:Settings, min:<ApiUrl url="js:number" label="number"/>, max:<ApiUrl url="js:number" label="number"/>, value:<ApiUrl url="js:number" label="number"/>, prefix:<ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:null" label="null"/>, suffix:<ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:null" label="null"/>) => <ApiUrl url="js:string" label="string"/></ApiBlock> {#definition-code}
