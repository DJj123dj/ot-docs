---
title: ODProgressBarRenderer_DefaultSettingsLabel
description: "All available label types for the default progress bar renderer"
...
# ODProgressBarRenderer_DefaultSettingsLabel <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/defaults/progressbar.ts#L12)
...
## Definition
#### <ApiBlock>"value"|"percentage"|"fraction"|"time-ms"|"time-sec"|"time-min"</ApiBlock> {#definition-code}
