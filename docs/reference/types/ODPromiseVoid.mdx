---
title: ODPromiseVoid
description: "This is a simple type to represent a callback return value that could be a promise or not."
...
# ODPromiseVoid <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L10)
...
## Definition
#### <ApiBlock><ApiUrl url="js:void" label="void"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
