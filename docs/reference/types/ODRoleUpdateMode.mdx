---
title: ODRoleUpdateMode
description: "This is the mode of the reaction role option in the config."
...
# ODRoleUpdateMode <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/role.ts#L168)
...
## Definition
#### <ApiBlock>"add&remove"|"add"|"remove"</ApiBlock> {#definition-code}
