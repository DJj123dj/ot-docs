---
title: ODSessionTimeoutCallback
description: "This is the callback used for session timeout listeners."
...
# ODSessionTimeoutCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/session.ts#L39)
...
## Definition
#### <ApiBlock>(id:<ApiUrl url="js:string" label="string"/>, timeout:"default"|"custom", data:any, creation:<ApiUrl url="js:date" label="Date"/>) => <ApiUrl url="js:void" label="void"/></ApiBlock> {#definition-code}
