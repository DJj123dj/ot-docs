---
title: ODSlashCommandRegisteredResult
description: "The result which will be returned when getting all (un)registered slash commands from the manager."
...
# ODSlashCommandRegisteredResult <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L737)
...
## Definition
#### <ApiBlock>\{registered:\{cmd:<ApiUrl url="interface:ODSlashCommandUniversalCommand" label="api.ODSlashCommandUniversalCommand"/>, instance:<ApiUrl url="class:ODSlashCommand" label="api.ODSlashCommand"/>, requiresUpdate:<ApiUrl url="js:boolean" label="boolean"/>\}[], unregistered:\{cmd:<ApiUrl url="js:null" label="null"/>, instance:<ApiUrl url="class:ODSlashCommand" label="api.ODSlashCommand"/>, requiresUpdate:true\}[], unused:\{cmd:<ApiUrl url="interface:ODSlashCommandUniversalCommand" label="api.ODSlashCommandUniversalCommand"/>, instance:<ApiUrl url="js:null" label="null"/>, requiresUpdate:false\}[]\}</ApiBlock> {#definition-code}
