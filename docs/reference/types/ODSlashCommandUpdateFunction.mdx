---
title: ODSlashCommandUpdateFunction
description: "The function responsible for updating slash commands when they already exist."
...
# ODSlashCommandUpdateFunction <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L933)
...
## Definition
#### <ApiBlock>(command:<ApiUrl url="interface:ODSlashCommandUniversalCommand" label="api.ODSlashCommandUniversalCommand"/>) => <ApiUrl url="js:boolean" label="boolean"/></ApiBlock> {#definition-code}
