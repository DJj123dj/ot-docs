---
title: ODStartScreenComponentRenderCallback
description: "This is the render function of a startscreen component. It also sends the location of where the component is rendered."
...
# ODStartScreenComponentRenderCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/startscreen.ts#L13)
...
## Definition
#### <ApiBlock>(location:<ApiUrl url="js:number" label="number"/>) => <ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
