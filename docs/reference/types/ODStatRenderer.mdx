---
title: ODStatRenderer
description: "This callback will render a single statistic for a discord embed/message."
...
# ODStatRenderer <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/stat.ts#L230)
...
## Definition
#### <ApiBlock>(value:<ApiUrl url="type:ODValidStatValue" label="api.ODValidStatValue"/>, scopeId:<ApiUrl url="js:string" label="string"/>, guild:discord.discord.Guild, channel:discord.discord.TextBasedChannel, user:discord.discord.User) => <ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
