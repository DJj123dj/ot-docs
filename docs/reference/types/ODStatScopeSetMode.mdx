---
title: ODStatScopeSetMode
description: "This type contains all valid methods for changing the value of a stat."
...
# ODStatScopeSetMode <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/stat.ts#L24)
...
## Definition
#### <ApiBlock>"set"|"increase"|"decrease"</ApiBlock> {#definition-code}
