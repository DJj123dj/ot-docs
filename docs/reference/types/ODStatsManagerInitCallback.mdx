---
title: ODStatsManagerInitCallback
description: "This callback can be used to execute something when the stats have been initiated. By default this is used to clear stats from users that left the server or tickets which don't exist anymore."
...
# ODStatsManagerInitCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/stat.ts#L19)
...
## Definition
#### <ApiBlock>(database:<ApiUrl url="type:ODJsonDatabaseStructure" label="api.ODJsonDatabaseStructure"/>, deletables:<ApiUrl url="type:ODJsonDatabaseStructure" label="api.ODJsonDatabaseStructure"/>) => <ApiUrl url="js:void" label="void"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
