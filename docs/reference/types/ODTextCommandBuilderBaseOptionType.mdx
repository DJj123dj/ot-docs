---
title: ODTextCommandBuilderBaseOptionType
description: "The types available in the text command option builder."
...
# ODTextCommandBuilderBaseOptionType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L976)
...
## Definition
#### <ApiBlock>"string"|"number"|"boolean"|"user"|"guildmember"|"role"|"mentionable"|"channel"</ApiBlock> {#definition-code}
