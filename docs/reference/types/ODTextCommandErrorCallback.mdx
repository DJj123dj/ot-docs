---
title: ODTextCommandErrorCallback
description: "Callback for the text command error listener."
...
# ODTextCommandErrorCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1263)
...
## Definition
#### <ApiBlock>(error:<ApiUrl url="type:ODTextCommandError" label="api.ODTextCommandError"/>) => <ApiUrl url="js:void" label="void"/></ApiBlock> {#definition-code}
