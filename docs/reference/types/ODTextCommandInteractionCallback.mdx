---
title: ODTextCommandInteractionCallback
description: "Callback for the text command interaction listener."
...
# ODTextCommandInteractionCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/client.ts#L1161)
...
## Definition
#### <ApiBlock>(msg:discord.discord.Message, cmd:<ApiUrl url="class:ODTextCommand" label="api.ODTextCommand"/>, options:<ApiUrl url="type:ODTextCommandInteractionOption" label="api.ODTextCommandInteractionOption"/>[]) => <ApiUrl url="js:void" label="void"/></ApiBlock> {#definition-code}
