---
title: ODTranscriptCompilerCompileFunction
description: "This function will generate/compile the transcript itself."
...
# ODTranscriptCompilerCompileFunction <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L39)
...
## Definition
#### <ApiBlock>(ticket:<ApiUrl url="class:ODTicket" label="api.ODTicket"/>, channel:discord.discord.TextChannel, user:discord.discord.User) => <ApiUrl url="interface:ODTranscriptCompilerCompileResult" label="api.ODTranscriptCompilerCompileResult"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
