---
title: ODTranscriptCompilerInitFunction
description: "This function will initiate/prepare the transcript system for an incoming transcript."
...
# ODTranscriptCompilerInitFunction <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L34)
...
## Definition
#### <ApiBlock>(ticket:<ApiUrl url="class:ODTicket" label="api.ODTicket"/>, channel:discord.discord.TextChannel, user:discord.discord.User) => <ApiUrl url="interface:ODTranscriptCompilerInitResult" label="api.ODTranscriptCompilerInitResult"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
