---
title: ODTranscriptCompilerReadyFunction
description: "This function will finish, clear-up & shut-down the transcript system. This will also initiate the sending of the messages to all recipients."
...
# ODTranscriptCompilerReadyFunction <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L44)
...
## Definition
#### <ApiBlock>(result:<ApiUrl url="interface:ODTranscriptCompilerCompileResult" label="api.ODTranscriptCompilerCompileResult"/>) => <ApiUrl url="interface:ODTranscriptCompilerReadyResult" label="api.ODTranscriptCompilerReadyResult"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
