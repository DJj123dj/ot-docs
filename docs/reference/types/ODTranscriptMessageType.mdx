---
title: ODTranscriptMessageType
description: "A message type for the `ODTranscriptMessageData` interface."
...
# ODTranscriptMessageType <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/openticket/transcript.ts#L485)
...
## Definition
#### <ApiBlock>"default"|"important"|"ephemeral"|"pinned.message"|"welcome.message"|"boost.message"|"thread.message"</ApiBlock> {#definition-code}
