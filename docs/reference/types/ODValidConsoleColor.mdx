---
title: ODValidConsoleColor
description: "This is a collection of all the supported console colors within Open Ticket."
...
# ODValidConsoleColor <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/console.ts#L13)
...
## Definition
#### <ApiBlock>"white"|"red"|"yellow"|"green"|"blue"|"gray"|"cyan"|"magenta"</ApiBlock> {#definition-code}
