---
title: ODValidId
description: "This is a valid Open Ticket identifier. It can be an `ODId` or `string`! You will see this type in many functions from Open Ticket."
...
# ODValidId <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/base.ts#L28)
...
## Definition
#### <ApiBlock><ApiUrl url="js:string" label="string"/>|<ApiUrl url="class:ODId" label="api.ODId"/></ApiBlock> {#definition-code}
