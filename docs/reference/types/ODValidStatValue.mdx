---
title: ODValidStatValue
description: "These are the only allowed types for a stat value to improve compatibility with different database systems."
...
# ODValidStatValue <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/stat.ts#L12)
...
## Definition
#### <ApiBlock><ApiUrl url="js:string" label="string"/>|<ApiUrl url="js:number" label="number"/>|<ApiUrl url="js:boolean" label="boolean"/></ApiBlock> {#definition-code}
