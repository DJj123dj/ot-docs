---
title: ODWorkerCallback
description: "This is the callback used in `ODWorker`!"
...
# ODWorkerCallback <M color="brown">type</M>
...
> [**View Source**](https://otgithub.dj-dj.be/tree/main/src/core/api/modules/worker.ts#L9)
...
## Definition
#### <ApiBlock>(instance:Instance, params:Params, source:Source, cancel:() => <ApiUrl url="js:void" label="void"/>) => <ApiUrl url="js:void" label="void"/>|<ApiUrl url="js:promise" label="Promise"/></ApiBlock> {#definition-code}
