...
<GoodImage src="/img/docs-v3/installation/devportal_permissions.png" size="90%"></GoodImage>
...
<GoodImage src="/img/docs-v3/installation/devportal_intents.png" size="90%"></GoodImage>